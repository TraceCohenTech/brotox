...
import { articles, getArticleBySlug } from "@/app/blog/data/articles-extra2";
...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://brotoxofficial.com/blog/${slug}` },
    openGraph: {
      title: article.metaTitle,
      description: article.description,
      type: "article",
                  ...
                  <div key={i}>
                    ...
                    {showCta && (
                      <div className="bg-blue-500/10 border border-blue-500/20 rounded-xl p-6 my-8 text-center">
                        ...
                        <Link href="/find-botox-near-me" className="btn-primary inline-block py-3 px-6 text-sm">
                          Search by Zip Code →
                        </Link>
                      </div>
                    )}
